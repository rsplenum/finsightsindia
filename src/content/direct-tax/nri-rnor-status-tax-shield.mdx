...
<div className="my-12">
<CardPremium title="TL;DR: The RNOR Shield" variant="warning">
- **The Core Issue:** Returning to India triggers massive taxation on your global wealth once you become a permanent Resident (ROR).
- **The Mechanics:** If you were an NRI for 9 of the last 10 years, the government grants you a 2-to-3 year RNOR grace period where your foreign income remains 100% tax-free in India.
- **The Defense:** Use this 3-year window to liquidate overseas assets and restructure your foreign bank accounts without tax penalties. But remember: you MUST report all foreign assets in Schedule FA, or face a ₹10 Lakh Black Money Act penalty.
</CardPremium>
</div>
