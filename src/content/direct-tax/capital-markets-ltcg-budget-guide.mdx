...
<div className="my-12">
<CardPremium title="TL;DR: The Capital Gains Math" variant="warning">
- **The Core Issue:** The 2024 Budget increased Long-Term Capital Gains (LTCG) tax to 12.5% and Short-Term Capital Gains (STCG) to 20%.
- **The Mechanics:** You are paying more tax on equity profits. However, the annual tax-free LTCG limit was increased to ₹1.25 Lakhs.
- **The Defense:** Use "Tax Harvesting." Sell and immediately rebuy assets before March 31st to book exactly ₹1.25 Lakhs in tax-free profit, permanently shielding that wealth. 
</CardPremium>
</div>
