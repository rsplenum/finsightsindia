...
The Indian freelance economy is booming, with developers, designers, and consultants billing clients in the US, UK, and UAE. Because the money comes in USD and the clients are outside India, most freelancers operate under a dangerous assumption: *"I don't sell to Indians, so Indian GST rules don't apply to me."*

**The TL;DR Final Answer:** If your total global income exceeds ₹20 Lakhs per year (₹10 Lakhs in Special Category states), GST registration is **mandatory**, even if 100% of your clients are foreign. However, "Export of Services" is categorized as a "Zero-Rated Supply." This means while you *must* register and file returns, you can legally pay **0% GST** by using a specific loophole called the Letter of Undertaking (LUT).
