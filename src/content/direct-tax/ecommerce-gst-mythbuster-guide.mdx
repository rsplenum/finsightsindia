...
<div className="my-12">
<CardPremium title="TL;DR: The E-commerce GST Trap" variant="warning">
- **The Core Issue:** The ₹40 Lakh GST exemption is a myth for e-commerce sellers on Amazon, Flipkart, etc.
- **The Mechanics:** Section 24 overrides the exemption limit for third-party marketplaces, forcing a ₹0 threshold. E-commerce platforms deduct 1% TCS, alerting the tax department immediately.
- **The Defense:** Register for standard GST from Day 1. Avoid the Composition Scheme (which bans inter-state sales) and meticulously claim Input Tax Credit (ITC) on all platform fees to offset your tax liability.
</CardPremium>
</div>
