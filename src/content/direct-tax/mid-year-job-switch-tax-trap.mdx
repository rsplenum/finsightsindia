...
<div className="my-12">
<CardPremium title="TL;DR: The Duplicate Exemption Trap" variant="warning">
- **The Core Error:** When you joined the new company, you failed to submit **Form 12B** to declare your previous salary. Because the new HR was blind to your old income, they assumed your salary from September to March was your *only* income for the year.
- **The Mathematics:** The new company granted you a fresh ₹3 Lakh Basic Exemption Limit and a fresh ₹75,000 Standard Deduction. Because your old company already gave you these exact same exemptions, you effectively claimed the tax-free limit *twice*.
- **The July Reckoning:** The IT portal perfectly aggregates your total income, strips away the duplicate exemptions, and pushes you into a much higher tax slab, resulting in a massive tax shortfall.
- **The Penalty:** Because your TDS was artificially low, you failed to pay adequate "Advance Tax" by March 15th, triggering mandatory 1% per month penal interest under **Sections 234B and 234C**.
</CardPremium>
</div>
