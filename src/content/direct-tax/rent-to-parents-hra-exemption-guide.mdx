...
<div className="my-12">
<CardPremium title="TL;DR: The 'Rent to Parents' Scrutiny" variant="warning">
- **The Core Issue:** Paying rent to your parents to claim House Rent Allowance (HRA) is legally valid, but it is the top trigger for tax scrutiny notices.
- **The Mechanics:** The tax department uses the Annual Information Statement (AIS) to match your HRA claim against your parent's declared rental income. A mismatch triggers a brutal 200% penalty under Section 270A.
- **The Defense:** Execute a formal, notarized rent agreement. Ensure all rent is transferred digitally (NEFT/UPI) every month. Most importantly, your parents must file an ITR declaring the exact rent you paid them.
</CardPremium>
</div>
