...
coverImage: "142-1-sft-anxiety.jpg"
---
...
import imgAnxiety from "../../assets/images/142-1-sft-anxiety.jpg";
import imgRelief from "../../assets/images/142-1-defense-relief.jpg";

<img src={imgAnxiety.src} class="w-full rounded-xl my-6 mix-blend-multiply dark:invert dark:mix-blend-screen" alt="SFT Trap Anxiety" />

<div className="my-12">
<CardPremium title="TL;DR: The Section 142(1) Inquiry" variant="warning">
- **The Core Issue:** The SFT dragnet tracks consumption, not just income. Paying a large credit card bill with past savings will trigger an algorithmic mismatch against your current low income.
- **The Mechanics:** A high-value SFT mismatch triggers an automated Section 142(1) inquiry demanding you explain the "Source of Funds" to prevent a tax raid.
- **The Defense:** Respond in the Compliance Portal with the "Holy Trinity" of proof (Identity, Genuineness, Creditworthiness). Categorize the funds (e.g., past savings, gifts) and upload bank ledgers/gift deeds as evidence.
</CardPremium>
</div>

## The Historical Intent & Legal Shift

To defeat the algorithm, you must first understand why it was built. Let’s dissect the historical intent through its historical and mechanical evolution.
...
<NoticeTrap title="The Accumulated Savings Trap">
**The Trigger:** You pay a ₹12 Lakh credit card bill using tax-paid savings from previous years, but your current year ITR shows only ₹5 Lakhs income.

**The Solution:** Do not panic and do not revise your ITR to artificially inflate your income. In the Compliance Portal, select 'Out of Earlier Income/Savings' and upload your past 3 years' ITRs and the bank account ledger proving the money was sitting in your account prior to the current financial year.
</NoticeTrap>

<NoticeTrap title="The Family Gift Trap">
**The Trigger:** Your father transfers ₹20 Lakhs to your bank account to help you buy a house. The SFT flags a ₹20 Lakh mutual fund/property purchase against your meager ₹4 Lakh salary.

**The Solution:** Gifts from relative (lineal ascendants) are 100% tax-free under Section 56(2)(x). In the portal, select 'Received as Gift'. You must immediately draft and execute a 'Gift Deed' on stamp paper and upload it alongside your father's bank statement showing the transfer.
</NoticeTrap>

<NoticeTrap title="The Joint Property Trap">
**The Trigger:** You and your spouse buy a ₹50 Lakh property jointly (50-50). The sub-registrar files an SFT mapping the entire ₹50 Lakhs to YOUR PAN because you were listed as the primary buyer on the registry.

**The Solution:** The SFT is blind to joint ownership ratios. In the portal, you must select 'Information is Partially Correct'. You then explicitly state that your share is only 50% (₹25 Lakhs) and provide your spouse's PAN and bank statements proving they paid the other half.
</NoticeTrap>
...
<img src={imgRelief.src} class="w-full rounded-xl my-6 mix-blend-multiply dark:invert dark:mix-blend-screen" alt="SFT Trap Relief" />
