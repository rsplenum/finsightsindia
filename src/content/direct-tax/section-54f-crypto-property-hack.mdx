...
statutoryAct2025: ""
coverImage: "section54f-crypto-anxiety.jpg"
---
...
<div className="my-12">
<CardPremium title="TL;DR: The Section 54F Exemption" variant="warning">
- **The Core Issue:** Liquidating massive wealth (startup equity, stocks) triggers brutal capital gains tax. Section 54F allows you to erase this tax completely by buying real estate.
- **The Mechanics:** Reinvest the *entire sale proceeds* (not just the profit) into a single residential house in India to get a 100% tax exemption.
- **The Defense:** Buy the house within 2 years (or 3 for construction) or park funds in a CGAS vault before July 31st. Note the new 2023 limit: the maximum allowable reinvestment is now capped at ₹10 Crores.
</CardPremium>
</div>
