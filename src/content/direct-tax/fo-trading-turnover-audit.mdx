...
<CardPremium>
### TL;DR
- **The Delusion:** Retail traders assume their weekend F&O hobby is just "Capital Gains". Legally, F&O is ALWAYS a Non-Speculative Business under Section 43(5).
- **The Absolute Turnover Illusion:** The algorithm calculates your volume by adding your profits and your losses together. A ₹50,000 account can easily trigger a ₹10 Crore Audit.
- **The Trap:** When forced into an audit, traders try to claim rent and laptops as business expenses to lower their tax. The human tax officer rejects these, claiming trading is just a hobby. You lose on both ends.
- **The Rescue:** You can carry forward F&O losses for 8 years to offset future business profits, but only if you file ITR-3 before the July 31st deadline and NEVER offset them against salary.
</CardPremium>
</div>
