...
coverImage: "270a-misreporting-anxiety.jpg"
---
...
<div className="my-12">
<CardPremium title="TL;DR: The Section 270A Trap" variant="warning">
- **The Core Issue:** The algorithm categorizes tax additions into two tiers: Under-reporting (50% penalty) and Misreporting (200% penalty).
- **The Mechanics:** If an expense is denied, it defaults to a 50% penalty. But if the Assessing Officer alleges you submitted fake invoices or suppressed facts, it upgrades to "misreporting," triggering a brutal 200% penalty that blocks settlement immunity.
- **The Defense:** If the Show Cause Notice fails to specify the exact statutory clause of misreporting, the notice is legally defective and can be quashed in court. Always rely on the Section 270A(6) "bona fide" safe harbor by disclosing all facts upfront.
</CardPremium>
</div>
