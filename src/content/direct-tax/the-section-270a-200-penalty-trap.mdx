...
<div class="my-8 flex flex-col md:flex-row items-center justify-center gap-4 text-center">
  <div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 p-4 rounded-xl w-full md:w-auto shadow-sm">
    <div class="text-xs text-red-600 dark:text-red-400 font-bold uppercase tracking-wider mb-1">Step 1</div>
    <div class="font-bold text-slate-800 dark:text-slate-200">Tax on Assessed Income</div>
  </div>
  <div class="text-3xl font-bold text-slate-400 dark:text-slate-600 hidden md:block">-</div>
  <div class="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 p-4 rounded-xl w-full md:w-auto shadow-sm">
    <div class="text-xs text-emerald-600 dark:text-emerald-400 font-bold uppercase tracking-wider mb-1">Step 2</div>
    <div class="font-bold text-slate-800 dark:text-slate-200">Tax on Returned Income</div>
  </div>
  <div class="text-3xl font-bold text-slate-400 dark:text-slate-600 hidden md:block">=</div>
  <div class="bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-200 dark:border-indigo-800 p-4 rounded-xl w-full md:w-auto shadow-sm ring-2 ring-indigo-500/50">
    <div class="text-xs text-indigo-600 dark:text-indigo-400 font-bold uppercase tracking-wider mb-1">Result</div>
    <div class="font-bold text-indigo-900 dark:text-indigo-200">Tax on Under-Reported Income</div>
  </div>
</div>
...
<div class="my-8 flex flex-col md:flex-row items-center justify-center gap-4 text-center">
  <div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 p-4 rounded-xl w-full md:w-auto shadow-sm">
    <div class="text-xs text-red-600 dark:text-red-400 font-bold uppercase tracking-wider mb-1">New Tax</div>
    <div class="font-bold text-slate-800 dark:text-slate-200">Tax on Reassessed Income</div>
  </div>
  <div class="text-3xl font-bold text-slate-400 dark:text-slate-600 hidden md:block">-</div>
  <div class="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 p-4 rounded-xl w-full md:w-auto shadow-sm">
    <div class="text-xs text-emerald-600 dark:text-emerald-400 font-bold uppercase tracking-wider mb-1">Old Tax</div>
    <div class="font-bold text-slate-800 dark:text-slate-200">Tax Assessed Previously</div>
  </div>
  <div class="text-3xl font-bold text-slate-400 dark:text-slate-600 hidden md:block">=</div>
  <div class="bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-200 dark:border-indigo-800 p-4 rounded-xl w-full md:w-auto shadow-sm ring-2 ring-indigo-500/50">
    <div class="text-xs text-indigo-600 dark:text-indigo-400 font-bold uppercase tracking-wider mb-1">Result</div>
...
<div class="my-8 space-y-4">
  <div class="flex flex-col md:flex-row items-center justify-center gap-4 text-center p-4 bg-slate-50 dark:bg-navy-900/50 rounded-xl border border-slate-200 dark:border-navy-800">
    <div class="w-full md:w-1/2">
      <div class="text-xs text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider mb-2">Part A: MAT Addition</div>
      <div class="bg-white dark:bg-navy-800 p-3 rounded-lg shadow-sm border border-slate-200 dark:border-navy-700 text-sm font-bold text-slate-800 dark:text-slate-200">
        Tax on Assessed MAT - Tax on Returned MAT
      </div>
    </div>
    <div class="text-2xl font-bold text-indigo-500">+</div>
    <div class="w-full md:w-1/2">
      <div class="text-xs text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider mb-2">Part B: Normal Income Addition</div>
      <div class="bg-white dark:bg-navy-800 p-3 rounded-lg shadow-sm border border-slate-200 dark:border-navy-700 text-sm font-bold text-slate-800 dark:text-slate-200">
        Tax on Assessed Normal Income - Tax on Returned Normal Income
      </div>
    </div>
  </div>
  <div class="bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-200 dark:border-indigo-800 p-4 rounded-xl text-center shadow-sm ring-2 ring-indigo-500/50">
    <div class="text-xs text-indigo-600 dark:text-indigo-400 font-bold uppercase tracking-wider mb-1">Total Result</div>
    <div class="font-bold text-indigo-900 dark:text-indigo-200">Aggregate Tax on Under-Reported Income</div>
  </div>
</div>
...
<NoticeTrap title="The Loss Return Trap">
...
<div class="my-6 grid grid-cols-1 md:grid-cols-3 gap-4">
  <div class="bg-slate-50 dark:bg-navy-900 border border-slate-200 dark:border-navy-800 p-4 rounded-xl text-center shadow-sm">
    <div class="text-xs text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider mb-1">Claimed Loss</div>
    <div class="font-bold text-slate-800 dark:text-slate-200">₹50,00,000</div>
  </div>
  <div class="bg-slate-50 dark:bg-navy-900 border border-slate-200 dark:border-navy-800 p-4 rounded-xl text-center shadow-sm">
    <div class="text-xs text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider mb-1">Assessed Loss</div>
    <div class="font-bold text-slate-800 dark:text-slate-200">₹20,00,000</div>
  </div>
  <div class="bg-rose-50 dark:bg-rose-900/20 border border-rose-200 dark:border-rose-800 p-4 rounded-xl text-center shadow-sm ring-2 ring-rose-500/50">
    <div class="text-xs text-rose-600 dark:text-rose-400 font-bold uppercase tracking-wider mb-1">Under-Reported Amount</div>
    <div class="font-bold text-rose-900 dark:text-rose-200">₹30,00,000</div>
  </div>
</div>
...
<div class="my-6 grid grid-cols-1 md:grid-cols-3 gap-4">
  <div class="bg-slate-50 dark:bg-navy-900 border border-slate-200 dark:border-navy-800 p-4 rounded-xl text-center shadow-sm">
    <div class="text-xs text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider mb-1">Claimed Loss Ignored</div>
    <div class="font-bold text-slate-800 dark:text-slate-200">₹20,00,000</div>
  </div>
  <div class="bg-slate-50 dark:bg-navy-900 border border-slate-200 dark:border-navy-800 p-4 rounded-xl text-center shadow-sm">
    <div class="text-xs text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider mb-1">Plus Positive Income Added</div>
    <div class="font-bold text-slate-800 dark:text-slate-200">₹30,00,000</div>
  </div>
  <div class="bg-rose-50 dark:bg-rose-900/20 border border-rose-200 dark:border-rose-800 p-4 rounded-xl text-center shadow-sm ring-2 ring-rose-500/50">
    <div class="text-xs text-rose-600 dark:text-rose-400 font-bold uppercase tracking-wider mb-1">Total Under-Reporting Base</div>
    <div class="font-bold text-rose-900 dark:text-rose-200">₹50,00,000</div>
  </div>
</div>
