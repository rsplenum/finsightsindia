...
<CardPremium>
### TL;DR
- **Don't get labeled:** If a tax officer rejects your expense and tags it as "misreporting", your penalty instantly quadruples to 200%. 
- **Disclose everything upfront:** You can't talk your way out of a penalty later. Disclosing all facts when you file is your only 100% shield.
- **Check their paperwork:** If the tax officer's notice doesn't clearly say whether you "under-reported" or "misreported", the entire penalty is illegal and gets thrown out.
</CardPremium>
