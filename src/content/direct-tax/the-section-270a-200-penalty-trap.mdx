...
<img src="../../assets/images/270a-penalty-trap-light.jpg" class="w-full rounded-xl block dark:hidden my-6 border border-slate-200" alt="Illustration" />
<img src="../../assets/images/270a-penalty-trap-dark.jpg" class="w-full rounded-xl hidden dark:block my-6 border border-navy-800" alt="Illustration" />
